> ⚠️ **Important:** We have an Enterprise version for the plugin available.[Link to Download](https://urbancode.github.io/IBM-UCx-PLUGIN-DOCS/UCD/send-smtp-email/downloads.html). Please create an RFE if you find any feature missing.
